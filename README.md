...
Is the average height the same for males and females?
...
bash
   git clone https://github.com/NkIII3003/<repo-name>.git
   cd <repo-name>
Install the package locally:
r
   library(devtools)
   install("MyRPackage")
Open and render either report in RStudio or via terminal:
bash
